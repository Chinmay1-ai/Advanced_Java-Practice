...
public class DoctorDAO {
	...
	public static List<Doctor> getAllDoctors() {
		...
		try {
			Connection con = DBConnection.getConnection();
			String query = "select d.doctor_id, u.full_name, u.email, "
					+ "d.specialization, d.experience, dep.dept_name " + "from doctors d "
			...
			while (rs.next()) {
				...
				doc.setDepartmentName(rs.getString("dept_name"));
