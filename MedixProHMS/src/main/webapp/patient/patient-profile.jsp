...
<div class="card shadow-sm p-4">
	...
	<div class="row">
		...
		<div class="col-md-4 text-center">
			...
			<span class="badge bg-primary"> <%=p.getBloodGroup()%>
			</span>
		</div>
	...
	<ul class="nav nav-tabs mt-4" id="profileTabs">
		...
		<li class="nav-item">
			<button class="nav-link active" data-bs-toggle="tab"
				data-bs-target="#appointments">Appointments</button>
		</li>

		<li class="nav-item">
			<button class="nav-link" data-bs-toggle="tab"
				data-bs-target="#prescriptions">Prescriptions</button>
		</li>
 ...
 %>
					...
					<tr>
						<td colspan="3" class="text-center">No appointments available
						</td>
					</tr>
			...
			<a
				href="<%=request.getContextPath()%>/loadBookAppointment?patientId=<%=p.getPatientId()%>"
		...
		<div class="tab-pane fade" id="prescriptions">
			...
			<div class="alert alert-info">Prescriptions module coming next
				✔</div>
			<a href="<%=request.getContextPath()%>/viewPrescriptions?patientId=<%=p.getPatientId()%>"
   class="btn btn-primary">
    View Prescriptions
		...
		<div class="tab-pane fade" id="bills">
			...
			<div class="alert alert-info">Billing system coming next ✔</div>
